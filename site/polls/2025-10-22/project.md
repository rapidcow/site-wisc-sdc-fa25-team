...
that's kind of obvious.)  They are just my thoughts on each project.

*Click on each respective page for more information*.

| Title | Stack | Pros | Cons |
|:-----:|:-----:|:----:|:----:|
| **[Club Radar](../../ideas/club-radar)** | Flask WSGI, Anvil; Svelte later? | Most people were in favor of it at the meeting | Gathering data will be difficult |
